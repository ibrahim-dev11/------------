    ...
    return GestureDetector(
      onTap: () => showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          title: Text(l.logout, style: const TextStyle(fontFamily: 'NotoSansArabic', fontWeight: FontWeight.w800)),
          content: Text(l.logoutConfirm, style: const TextStyle(fontFamily: 'NotoSansArabic', fontWeight: FontWeight.w500)),
          actions: [
